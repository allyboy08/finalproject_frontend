...
function showtr(user) {
  const tableacc = `<tr data-id=${user.id}>
        <td>${user.id}</td>
        <td><input name="fname" type='text' value="${user.fname}"></td>
        <td><input name="uname" type='text' value="${user.uname}"></td>
        <td><input name="passw" type='text' value="${user.passw}"></td>
        <td><input name="email" type='text' value="${user.email}"></td>
        <td><button onclick="deleteAcc(${user.id})">delete</button></td>
        <td><button onclick="editAcc(${user.id})">edit</button></td>
      </tr>`;
